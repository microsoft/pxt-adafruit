...
<svg xmlns="http://www.w3.org/2000/svg" id="field-neopixels" viewBox="0 0 180.09375 179.22874">
  ...
  <g id="g632">
    <g id="g634" clip-path="url(#clipPath636)" transform="matrix(1.25 0 0 -1.25 0 179.23)">
      ...
      <g id="g2456" opacity=".65">
        <path id="BTN_A_INNER" fill="#ccc" d="M43.957 70.7308c-2.348 0-4.252 1.904-4.252 4.252 0 2.349 1.904 4.252 4.252 4.252 2.349 0 4.252-1.903 4.252-4.252 0-2.348-1.903-4.252-4.252-4.252m-9.0698-2.2675v-1.983h18.141v1.983h1.701v1.7h-1.701v9.639h1.701v1.701h-1.701v1.983h-18.141v-1.983h-1.701v-1.701h1.701v-9.639h-1.701v-1.7h1.701z"/>
      </g>
      <g id="g2468" opacity=".65">
        <path id="BTN_B_INNER" fill="#ccc" d="M100.1177 70.7308c-2.349 0-4.252 1.904-4.252 4.252 0 2.349 1.903 4.252 4.252 4.252 2.348 0 4.252-1.903 4.252-4.252 0-2.348-1.904-4.252-4.252-4.252m-9.0703-2.2675v-1.983h18.141v1.983h1.701v1.7h-1.701v9.639h1.701v1.701h-1.701v1.983h-18.141v-1.983h-1.701v-1.701h1.701v-9.639h-1.701v-1.7h1.701z"/>
      </g>
  ...
  <path id="paletteslice2" data-color="orange" fill="orange" stroke="#781927" stroke-opacity="0" stroke-width="1.61524105" d="M122.08203 60.773438l-19.05664 19.05664a16.268755 16.268755 0 0 1 3.125 7.527344h26.93164a43.153011 43.153011 0 0 0-11-26.583984z" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path id="paletteslice7" data-color="pink" fill="pink" stroke="#781927" stroke-opacity="0" stroke-width="1.61524105" d="M58.025391 60.787109a43.153011 43.153011 0 0 0-11.050782 26.570313h26.980469a16.268755 16.268755 0 0 1 3.117188-7.523438L58.025391 60.787109z" stroke-linecap="round" stroke-linejoin="round"/>
