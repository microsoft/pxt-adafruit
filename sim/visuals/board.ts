namespace pxsim.visuals {
    ...
    const pinNames: {'name': string, 'touch': number, 'text': any, 'id'?: number}[] = [
        { 'name': "SCL", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A4 },
        { 'name': "SDA", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A5 },
        { 'name': "RX", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A6 },
        { 'name': "TX", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A7 },
        { 'name': "PIN_8", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A8 },
        { 'name': "PIN_9", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A9 },
        { 'name': "PIN_10", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A10 },
        { 'name': "PIN_11", 'touch': 1, 'text': null, 'id': pxsim.CPlayPinName.A11 },
        { 'name': "GND_0", 'touch': 0, 'text': null },
        { 'name': "GND_1", 'touch': 0, 'text': null },
        { 'name': "VBATT", 'touch': 0, 'text': null },
        ...
        private buildDom() {
            ...
            this.pins = pinNames.map((pin, i) => {
                ...
                if (p) {
                    ...
                    svg.hydrate(p, { title: pinTitles[i] })
                }
                return p;
            });
