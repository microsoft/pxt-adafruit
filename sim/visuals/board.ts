namespace pxsim.visuals {
    ...
    export class MicrobitBoardSvg implements BoardView {
        ...
        private buildDom() {
            ...
            svg.child(neopixelglow, "feGaussianBlur", { stdDeviation: "2.5", result: "coloredBlur" });
